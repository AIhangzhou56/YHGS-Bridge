...
echo "2. Configure DNS: api.yhgs.chat -> your server IP"
echo "3. Install SSL: certbot --nginx -d yhgs.chat -d api.yhgs.chat"
echo "4. Test API: curl https://api.yhgs.chat/api/tokens"